...
const (
	serverIP   = "" // specify empty string to listen on all available interfaces
	serverPort = "54321" // port to listen on
	serverType = "udp4" // using udp4 for IPv4
	bufferSize = 2048 // buffer size for incoming messages
)
